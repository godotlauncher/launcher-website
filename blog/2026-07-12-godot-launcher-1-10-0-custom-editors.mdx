...
<p>
  <ThemedImage
    ...
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.10.0/screen_installs_custom_editors_light.webp',
      dark: '/img/blog/images/1.10.0/screen_installs_custom_editors_dark.webp',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.10.0/screen_projects_new_project_custom_editor_light.webp',
      dark: '/img/blog/images/1.10.0/screen_projects_new_project_custom_editor_dark.webp',
    }}
  />
</p>
...
See the [Custom Editor Manifest Format](https://docs.godotlauncher.org/1.10/reference/custom-editor-manifest/) for the supported fields, an example, and validation behavior.
...
<p>
  <ThemedImage
    ...
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.10.0/screen_installs_custom_editor_drawer_light.webp',
      dark: '/img/blog/images/1.10.0/screen_installs_custom_editor_drawer_dark.webp',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.10.0/screen_projects_editor_resolution_light.webp',
      dark: '/img/blog/images/1.10.0/screen_projects_editor_resolution_dark.webp',
    }}
  />
</p>
...
<p>
  <ThemedImage
    ...
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.10.0/screen_projects_vscode_config_recovered_light.webp',
      dark: '/img/blog/images/1.10.0/screen_projects_vscode_config_recovered_dark.webp',
    }}
  />
</p>
...
- [Custom-Built Godot Editors](https://docs.godotlauncher.org/1.10/editors/custom-editors/)
- [Add an Existing Project](https://docs.godotlauncher.org/1.10/getting-started/add-existing-project/)
