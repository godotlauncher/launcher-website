...
[All badges](https://docs.godotlauncher.org/1.10/reference/project-badges/) now include tooltips when you hover over them, making the interface clearer and more informative at a glance. This is part of our ongoing effort to improve usability across the launcher.
...
Read the documentation page **[Launch Godot Project in Windowed Mode](https://docs.godotlauncher.org/1.10/projects/launch-godot-project-in-windowed-mode/)**.
...
- [Project Badges](https://docs.godotlauncher.org/1.10/reference/project-badges/) visual indicators for (c#), (pr), and (w) now include tooltips.
