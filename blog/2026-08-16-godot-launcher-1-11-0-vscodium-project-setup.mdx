...
See [Code Editor Settings](https://docs.godotlauncher.org/settings/code-editors/), [Visual Studio Code Setup for Godot](https://docs.godotlauncher.org/integrations/vscode-setup-for-godot/), and [VSCodium Setup for Godot](https://docs.godotlauncher.org/integrations/vscodium-setup-for-godot/) for setup details.
...
See [Creating a Project](https://docs.godotlauncher.org/getting-started/create-project/) and [Using Git With Godot Launcher](https://docs.godotlauncher.org/integrations/using-git-with-godot-launcher/) for the full setup options.
...
See [Installing a Godot Editor](https://docs.godotlauncher.org/getting-started/install-editor/) for a closer look at the catalog and install states.
...
See [Project Settings](https://docs.godotlauncher.org/projects/project-settings/) for all available choices.
...
- [Manage Projects](https://docs.godotlauncher.org/projects/manage-projects/)
- [Visual Studio Code Setup for Godot](https://docs.godotlauncher.org/integrations/vscode-setup-for-godot/)
- [VSCodium Setup for Godot](https://docs.godotlauncher.org/integrations/vscodium-setup-for-godot/)
