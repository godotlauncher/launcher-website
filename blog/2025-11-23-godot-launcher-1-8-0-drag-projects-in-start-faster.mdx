...
<p>
  <ThemedImage
    ...
    alt="Projects view showing added entries"
    decoding="async"
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.8.0/screen_projects_drop_overlay_light.webp',
      dark: '/img/blog/images/1.8.0/screen_projects_drop_overlay_dark.webp',
    }}
  />
</p>
...
<p>
  <ThemedImage
    className="blogThemedImage"
    alt="Settings view with updates options"
    decoding="async"
    loading="lazy"
    sources={{
      light: '/img/blog/images/1.8.0/screen_settings_updates_light.webp',
      dark: '/img/blog/images/1.8.0/screen_settings_updates_dark.webp',
    }}
  />
</p>
