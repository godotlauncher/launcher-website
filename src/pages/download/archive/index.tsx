  ...
  return (
    ...
    >
      <div className="container margin-vert--lg">
        ...
        <p>
          This page contains previous releases of{" "}
          <strong className="">Godot Launcher</strong>. All downloads are hosted
          on GitHub. You can also find these releases on the{" "}
          <Link
