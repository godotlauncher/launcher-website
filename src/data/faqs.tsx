...
export const faqSections: FAQSection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answerHTML: (
          <>
            ...
            ) making it easier to switch between them without manual
            installation.
            <span className="line-break" />
            Godot Launcher also offers additional features like Git integration, Visual Studio Code setup,
      ...
      },
      {
        ...
        answerHTML: (
          <>
            Yes, once you have downloaded the Godot versions you need, you can
            use them offline.
          </>
        ),
        featureOrder: 3,
